...
async def namoz_vaqti(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    font = ImageFont.truetype( r"takr/Bilanger.ttf", 80)
    font1 = ImageFont.truetype(r"takr/Bilanger.ttf", 80)
    font2 = ImageFont.truetype( "takr/Bilanger.ttf", 80)
    font3 = ImageFont.truetype( "takr/Bilanger.ttf", 80)
    font4 = ImageFont.truetype( "takr/Bilanger.ttf", 80)
